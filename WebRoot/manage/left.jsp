...
<body style="background:#f0f9fd;">
	...
	<dl class="leftmenu">
		<dd>
			<div class="title">
				<span><img src="../images/leftico01.png" /></span>企业职位管理
			</div>
			<ul class="menuson">
				<li><cite></cite><a href="jobApplyList.jsp"
					target="rightFrame">职位申请查看</a><i></i></li>
				<li><cite></cite><a
					href="/Q_ITOffer_Manage/JobListServlet?pageNo=1"
					target="rightFrame">职位管理</a><i></i></li>
				<li><cite></cite><a
					href="/Q_ITOffer_Manage/CompanyListServlet?pageNo=1"
					target="rightFrame">企业管理</a><i></i></li>
			</ul>
		</dd>
		<dd>
			<div class="title">
				<span><img src="../images/leftico02.png" /></span>简历管理
			</div>
			<ul class="menuson">
		...
		<dd>
			<div class="title">
				<span><img src="../images/leftico04.png" /></span>密码修改
			</div>
		</dd>
	</dl>
</body>
